  ...
  return (
    <div className="container mx-auto my-10 px-4 text-center bg-transparent">
      <div className="mx-auto max-w-4xl h-auto border-none">
        ...
        <h1 className="text-[#BD904D] text-4xl md:text-5xl lg:text-6xl mb-6 md:mb-10">
          Perdana Main
        </h1>
        <h3 className="mx-auto text-[#ECDFCC] text-base md:text-lg lg:text-xl leading-relaxed">
      ...
      <div className="my-2 justify-center">
        <a
          href="#projects"
          className="inline-block px-6 py-[13px] mt-3 mr-4 text-lg font-semibold text-white bg-[#697565] rounded-lg hover:bg-[#A77D3D] transition-all duration-200"
        >
          about
        </a>
        ...
        <a
          href="#projects"
          className="inline-block px-5 py-3 mt-3 text-lg font-semibold text-white border-[1px] rounded-lg hover:bg-[#A77D3D] transition-all duration-200"
        >
          resume
        </a>
      </div>
      <div className="my-2 justify">
        <div className="flex justify-center space-x-4">
          <div className="text-white text-center">
            <a
              href="#projects"
              className="inline-block p-[2px] mt-3 text-lg font-semibold text-white bg-[#697565] rounded-full hover:bg-[#A77D3D] transition-all duration-200"
            >
